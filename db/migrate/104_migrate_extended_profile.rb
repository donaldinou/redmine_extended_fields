...
class MigrateExtendedProfile < ActiveRecord::Migration # PROFILE
    ...
    def self.up
        ...
        project      = UserCustomField.create(:name => 'Project of interest', :field_format => 'project', :position => pos += 1, :visible    => false, :searchable => true) # FIXME: required from settings
